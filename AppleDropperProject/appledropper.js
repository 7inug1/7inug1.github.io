...
//
// -Instruction : A revision from the Apple Dropper Game. Use the buttons provided
// or arrowleft and arrowright keyboards to move the character around to catch the
// food dropping from the top. If you achieve the designated score, you win the game.
//
// -(Personal) Note :
// Things to remember :
